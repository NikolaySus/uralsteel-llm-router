...
- If you find an empty cell in the table, this means that it inherits the value from the cell above and you MUST take the value from there. It is NOT possible for a cell value to be unregulated, except in cases where a dash is EXPLICITLY indicated.
